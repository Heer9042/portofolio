...
const WORDS = ["Technical Analyst.", "Technical Support."];
const TECH_STACK = ["React", "Php", "Python", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Heer9042" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/heerpatel9042/" },
  { icon: Instagram, link: "https://www.instagram.com/heerpatel_9042/" },
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0" data-aos="fade-right" data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light" data-aos="fade-up" data-aos-delay="1000">
                  A creative and detail-oriented Frontend Developer passionate about building fast, responsive, and scalable web interfaces. I specialize in React.js, Tailwind CSS, and JavaScript. Always eager to learn, adapt, and innovate with each project.
                </p>
